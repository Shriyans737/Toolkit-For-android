...
- PDF Splitter — pull out specific pages from a PDF
- PDF Merger — combine multiple PDFs into one
- Text to PDF — turn typed text into a formatted PDF

**Everyday Utilities**
- QR Code Generator — turn text or a link into a scannable QR code
